...
<body>
	...
	*/
	...
	function generateNavigationMenu(array $menuItems): string
	{
		$html = '<ul class="menu">';
		
		foreach ($menuItems as $menuItem) {
			$html .= '<li>';
			$html .= '<a href="' . htmlspecialchars($menuItem['href']) . '">';
			$html .= htmlspecialchars($menuItem['link']);
			$html .= '</a>';
			$html .= '</li>';
		}
	...
	// Выводим меню
	echo generateNavigationMenu($leftMenu);
	?> 
	</nav>
</body>
</html>